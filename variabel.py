# varianel adalah tempat menyimpan sebuah nilai atau value
a = 10;

print("nilai a =", a);  #ini adalaha cara di mana bahasa pemoograman python menempilkan teks dan memangil nilai a berbeda di flutter 
