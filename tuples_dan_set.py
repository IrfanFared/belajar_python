...
#sedankan set tidak dapat berisi item yang sama, jika kita mencoba menambahkan item yang sama, maka akan diabaikan
...
#jika kita ingin mengakses item di data set, kiba bisa mengakasesnya tetapi autpunya akan acak
